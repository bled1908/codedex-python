...
silchar = City("Silchar", "India", 323000, ["Kachakanti Kali Mandir", "Bhuban Mahadev Temple", "Gandhibag Park", "Badarpur Fort", "Kachari Fort"], "Island of Peace", 1832, "Niharendra Narayan Tagore")
dubai = City("Dubai", "United Arab Emirates[UAE]", 364000, ["Burj Al Arab", "Dubai Mall", "The Dubai Fountain", "Dubai Frame"], "Gulf Tiger", 1983, "Mohammed bin Rashid Al Maktoum")
